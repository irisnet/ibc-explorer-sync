...
import (
	...
	cdc "github.com/irisnet/ibc-explorer-sync/libs/msgparser/codec"
	models "github.com/irisnet/ibc-explorer-sync/libs/msgparser/types"
	"github.com/irisnet/ibc-explorer-sync/libs/msgparser/utils"
)
...
func UnmarshalAcknowledgement(bytesdata []byte) string {
	...
	if err := cdc.GetMarshaler().UnmarshalJSON(bytesdata, &result); err != nil {
